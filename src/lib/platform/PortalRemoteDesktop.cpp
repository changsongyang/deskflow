...
#include "platform/xdg_portal_remotedesktop_interface.h"
...
PortalRemoteDesktop::~PortalRemoteDesktop()
{
  ...
  static const auto leftCtrl = 29;
  static const auto rightCtrl = 97;
  static const auto leftShift = 42;
  static const auto rightShift = 54;
  static const auto leftAlt = 56;
  static const auto rightAlt = 100;
  static const auto leftMeta = 125;
  static const auto rightMeta = 126;
  ...
  for (auto keycode : {leftCtrl, rightCtrl, leftShift, rightShift, leftAlt, rightAlt, leftMeta, rightMeta}) {
...
void PortalRemoteDesktop::createSession(uint code, const QVariantMap &result)
{
  ...
  static const uint PermissionsPersistUntilExplicitlyRevoked = 0;
